...
const Sos: React.FC = () => {
  ...
  const sosNumbers = [
    { id: 1, icon: "ambulance", number: "110", description: "Fire & Rescue" },
    {
      ...
      icon: "ambulance",
      number: "1990",
      description: "Suwa Seriya Ambulance Service",
    },
    {
      id: 3,
      icon: "hospital",
      number: "0112691111",
      description: "Accident Service-General Hospital-Colombo",
    },
    {
      id: 4,
      icon: "info-circle",
      number: "0112136222",
      description: "Disaster Managment Centre Emergency Operations Hotline",
    },
    {
      id: 5,
      icon: "phone",
    ...
    },
    {
      ...
      number: "0112422222",
      description: "Fire & Ambulance Service",
    },
  ];
