        ...
        {disasters.map((disaster, index) => (
          <View key={index} style={styles.card}>
            ...
            <Text style={styles.cardStatus}>
              Status: 
              <Text style={disaster.resolved ? styles.statusUnavailable : styles.statusAvailable}>
            ...
            <Text style={styles.cardDistance}>
              Distance: {disaster.distance ? `${(disaster.distance / 1000).toFixed(2)} km` : 'Within radius'}
            </Text>
                      ...
                      },
                      {
                        ...
                        onPress: async () => {
                          try {
                            ...
                            Alert.alert("Error", "Failed to report victim. Please try again.");
                          }
                        },
                      },
                    ]
